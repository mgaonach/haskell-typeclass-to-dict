...
import compiler.haskell.Comment;
...
import compiler.haskell.TypeVar;
...
public class ExampleProgram {
	...
	public static Program getAST() {
		...
		program.add(new Attribution(new TermApplication(
				new TermApplication(new TermFunction("isSupNat"),
						new TermApplication(new TermConstructor("MySucc"), new TermVar("x"))),
				new TermApplication(new TermConstructor("MySucc"), new TermVar("y"))

		), new TermApplication(new TermApplication(new TermFunction("isSupNat"), new TermVar("x")), new TermVar("y"))));
		...
		program.add(new Attribution(
				new TermApplication(new TermApplication(new TermFunction("isSupNat"), new TermConstructor("MyZero")),
						new TermAny()),
				new TermConstructor("MyFalse")));

		// instance Compare MyBool and Compare MyNat
		Instance compareMyBool = new Instance(
				new TypeApplication(new TypeVar("Compare"), new TypeConstructor("MyBool")),
				new Attribution(new TermFunction("isSup"), new TermFunction("isSupBool")));
		program.add(compareMyBool);

		Instance compareMyNat = new Instance(new TypeApplication(new TypeVar("Compare"), new TypeConstructor("MyNat")),
				new Attribution(new TermFunction("isSup"), new TermFunction("isSupNat")));
		program.add(compareMyNat);

		// areAllSup
		FunctionDefinition areAllSupDef = new FunctionDefinition("areAllSup",
				new TypeFunction(new TypeFunction(
						new TypeFunction(new TypeApplication(new TypeVar("Compare"), new TypeVar("a")),
								new TypeApplication(new TypeConstructor("MyList"), new TypeVar("a"))),
						new TypeVar("a")), new TypeConstructor("MyBool")));
		program.add(areAllSupDef);

		program.add(new Attribution(
				new TermApplication(new TermApplication(new TermFunction("areAllSup"), new TermConstructor("MyNil")),
						new TermVar("n")),
				new TermConstructor("MyTrue")));

		program.add(new Attribution(
				new TermApplication(new TermApplication(new TermFunction("areAllSup"),
						new TermApplication(new TermApplication(new TermConstructor("MyCons"), new TermVar("x")),
								new TermVar("l"))),
						new TermVar("n")),
				new TermApplication(new TermApplication(new TermFunction("myAnd"),
						new TermApplication(new TermApplication(new TermFunction("areAllSup"), new TermVar("l")),
								new TermVar("n"))),
						new TermApplication(new TermApplication(new TermFunction("isSup"), new TermVar("x")),
								new TermVar("n")))));
		...
		FunctionDefinition isOddBoolDef = new FunctionDefinition("isOddBool",
				new TypeFunction(new TypeConstructor("MyBool"), new TypeConstructor("MyBool")));
		program.add(isOddBoolDef);

		program.add(new Attribution(new TermApplication(new TermFunction("isOddBool"), new TermVar("b")),
				new TermVar("b")));
		...
		program.add(new Attribution(new TermApplication(new TermFunction("isEvenBool"), new TermConstructor("MyTrue")),
				new TermConstructor("MyFalse")));
		program.add(new Attribution(new TermApplication(new TermFunction("isEvenBool"), new TermConstructor("MyFalse")),
				new TermConstructor("MyTrue")));

		// isOddNat
		FunctionDefinition isOddNatDef = new FunctionDefinition("isOddNat",
				new TypeFunction(new TypeConstructor("MyNat"), new TypeConstructor("MyBool")));
		program.add(isOddNatDef);
		program.add(new Attribution(new TermApplication(new TermFunction("isOddNat"), new TermConstructor("MyZero")),
				new TermConstructor("MyFalse")));
		program.add(new Attribution(
				new TermApplication(new TermFunction("isOddNat"),
						new TermApplication(new TermConstructor("MySucc"), new TermConstructor("MyZero"))),
				new TermConstructor("MyTrue")));
		program.add(new Attribution(
				new TermApplication(new TermFunction("isOddNat"),
						new TermApplication(new TermConstructor("MySucc"),
								new TermApplication(new TermConstructor("MySucc"), new TermVar("n")))),
				new TermApplication(new TermConstructor("isOddNat"), new TermVar("n"))));
		...
		program.add(new Attribution(new TermApplication(new TermFunction("isEvenNat"), new TermConstructor("MyZero")),
				new TermConstructor("MyTrue")));
		program.add(new Attribution(
				new TermApplication(new TermFunction("isEvenNat"),
						new TermApplication(new TermConstructor("MySucc"), new TermConstructor("MyZero"))),
				new TermConstructor("MyFalse")));
		program.add(new Attribution(
				new TermApplication(new TermFunction("isEvenNat"),
						new TermApplication(new TermConstructor("MySucc"),
								new TermApplication(new TermConstructor("MySucc"), new TermVar("n")))),
				new TermApplication(new TermFunction("isEvenNat"), new TermVar("n"))));

		// instance Parity MyBool and Parity MyNat
		Instance parityMyBool = new Instance(new TypeApplication(new TypeVar("Parity"), new TypeConstructor("MyBool")),

				new Attribution(new TermFunction("isOdd"), new TermFunction("isOddBool")),
				new Attribution(new TermFunction("isEven"), new TermFunction("isEvenBool"))

		);
		program.add(parityMyBool);
		Instance parityMyNat = new Instance(new TypeApplication(new TypeVar("Parity"), new TypeConstructor("MyNat")),

				new Attribution(new TermFunction("isOdd"), new TermFunction("isOddNat")),
				new Attribution(new TermFunction("isEven"), new TermFunction("isEvenNat"))
		...
		FunctionDefinition areAllEvenDef = new FunctionDefinition("areAllEven",
				new TypeFunction(
						new TypeConstraint(new TypeApplication(new TypeVar("Parity"), new TypeVar("a")),
								new TypeApplication(new TypeConstructor("MyList"), new TypeVar("a"))),
						new TypeConstructor("MyBool")));
		program.add(areAllEvenDef);
		program.add(new Attribution(new TermApplication(new TermFunction("areAllEven"), new TermConstructor("MyNil")),
				new TermConstructor("MyTrue")));
		program.add(new Attribution(
				new TermApplication(new TermFunction("areAllEven"),
						new TermApplication(new TermApplication(new TermConstructor("MyCons"), new TermVar("x")),
								new TermVar("l"))),
				new TermApplication(new TermFunction("myAnd"),
						new TermApplication(new TermApplication(new TermFunction("areAllEven"), new TermVar("l")),
								new TermApplication(new TermFunction("isEven"), new TermVar("x"))))));
		...
		Instance iParity2MyBool = new Instance(//
				...
				new Attribution(new TermFunction("isOdd2"), new TermFunction("isOddBool")), //
				new Attribution(new TermFunction("isEven2"), new TermFunction("isEvenBool"))//
		);
		...
		Instance iParity2MyNat = new Instance(//
				...
				new Attribution(new TermFunction("isOdd2"), new TermFunction("isOddNat")), //
				new Attribution(new TermFunction("isEven2"), new TermFunction("isEvenNat"))//
		);
		...
		program.add(new Attribution(new TermApplication(
				new TermApplication(new TermFunction("allEvenAreSup"), new TermConstructor("MyNil")), new TermVar("n")),
				new TermConstructor("MyTrue")));

		program.add(new Attribution(//
				new TermApplication(//
						new TermApplication(//
								new TermFunction("allEvenAreSup"), //
								new TermApplication(//
										new TermApplication(//
