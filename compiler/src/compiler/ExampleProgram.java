...
public class ExampleProgram {
	...
	public static Program getAST() {
		...
		ConstructorDefinition myConsDef = new ConstructorDefinition(//
				"MyCons", //
				new TypeVar("a"), //
				new TypeApplication(//
		...
		DataDefinition myListDef = new DataDefinition(//
				...
				Arrays.asList(myConsDef, myNilDef), //
				Arrays.asList(new TypeConstructor("Show")//
				)//
		);
		...
		Type typeCons = new TypeConstructor("Compare");
		Type typeParam = new TypeVar("a");
		TypeApplication typeApp = new TypeApplication(typeCons, typeParam);
		...
		// function Definition
		// "isSup :: a -> a -> MyBool"
		FunctionDefinition isSupDef = new FunctionDefinition(//
				"isSup", new TypeFunction(//
						new TypeFunction(//
								new TypeVar("a"), //
								new TypeVar("a")//
						), //
		...
		// isSupBool
		FunctionDefinition isSupBoolDef = new FunctionDefinition(//
				"isSupBool", //
				new TypeFunction(//
						new TypeFunction(//
								new TypeConstructor("MyBool"), //
		...
		// isSupNat
		FunctionDefinition isSupNatDef = new FunctionDefinition(//
				"isSupNat", //
				new TypeFunction(//
						new TypeFunction(//
		...
		// areAllSup
		FunctionDefinition areAllSupDef = new FunctionDefinition(//
				"areAllSup", //
				new TypeConstraint(//
						new TypeApplication(//
								new TypeConstructor("Compare"), //
		...
		Instance parityMyBool = new Instance(
				new TypeApplication(new TypeConstructor("Parity"), new TypeConstructor("MyBool")),
		...
		Instance parityMyNat = new Instance(
				new TypeApplication(new TypeConstructor("Parity"), new TypeConstructor("MyNat")),
		...
		FunctionDefinition areAllEvenDef = new FunctionDefinition("areAllEven",
				new TypeFunction(
						new TypeConstraint(new TypeApplication(new TypeConstructor("Parity"), new TypeVar("a")),
		...
		program.add(new Attribution(
				...
				new TermApplication(
						new TermApplication(new TermFunction("myAnd"),
								new TermApplication(new TermFunction("areAllEven"), new TermVar("l"))),
		...
		TypeConstraint parity2Type = new TypeConstraint(//
				new TypeApplication(new TypeConstructor("Compare"), new TypeVar("a")), //
				new TypeApplication(new TypeConstructor("Parity2"), new TypeVar("a"))//
		);
